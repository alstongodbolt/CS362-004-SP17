...
int adventurer1(struct gameState *state){
    int drawntreasure=3;
    int currentPlayer = whoseTurn(state);
    int cardDrawn;
...
int feast1(struct gameState *state, int choice1){
...
int mine1(struct gameState *state, int choice1, int choice2, int handPos){
    int currentPlayer = whoseTurn(state);
    int j = 1;
    int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
            return adventurer1(state);
    case council_room:
            return council_room1(state, handPos);
    case feast:
            return feast1(state, choice1);
    case gardens:
      return -1;
			
    case mine:
            return mine1(state, choice1, choice2, handPos);
    case remodel:
